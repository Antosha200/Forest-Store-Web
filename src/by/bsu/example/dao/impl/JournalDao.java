...
public class JournalDao extends AbstractDao<Integer, Journal> implements JournalDaoInterface {
    ...
    private static final String SQL_FIND_JOURNAL_BY_COURSE_ID="SELECT Journal.id, Journal.mark, Journal.miss,Journal.mdata, Journal.note, Journal.id_course, Journal.id_student, User.first_name, User.last_name FROM Journal LEFT JOIN User ON Journal.id_student = User.id WHERE Journal.id_course=? ORDER BY User.last_name, User.first_name";
