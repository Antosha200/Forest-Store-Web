...
<div id="mainmiddle">
    ...
    <%--<fmt:message key="${actionresult}" bundle="${msg}"/>--%>${actionresult} <a href="${contextPath}/controller?command=selectcourses"><fmt:message key="misc.actioncontinue" bundle="${txt}"/></a>
